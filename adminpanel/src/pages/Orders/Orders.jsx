...
const Orders = () => {
  ...
  const fetchOrders = async () => {
    const response = await axios.get('https://foodies-apps-nmhe.onrender.com/api/orders/all');
    setData(response.data);
  }

  const updateStatus = async (event, orderId) => {
    const response = await axios.patch(`https://foodies-apps-nmhe.onrender.com/api/orders/status/${orderId}?status=${event.target.value}`);
