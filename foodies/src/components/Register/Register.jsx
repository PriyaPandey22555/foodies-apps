          ...
          <div className="card-body p-4 p-sm-5">
            ...
            <form onSubmit={onSubmitHandler}>
              <div className="form-floating mb-3">
                <input type="text" className="form-control" id="floatingName" placeholder="Priya Pandey"
              ...
              <div className="d-grid">
                ...
                <button className="btn btn-outline-danger btn-login text-uppercase mt-2 " type="reset" onClick={() => setData({name:'', email:'', password:''})}>Reset</button>
              </div>
             <div className="mt-4">
